<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="New_OnlineJournal.Test2" MaintainScrollPositionOnPostback="true"%>
<!DOCTYPE html>
...
$(document).ready(function() {
    window.location.href = "#parentVerticalTab2";  //注意有个#
});   
</script>
			...
			<div class="category-list">
			  <div id="parentVerticalTab">
					...
					<ul class="resp-tabs-list hor_1">
					  ...
					  <li><i class="icon fa fa-tag" aria-hidden="true"></i>分类搜索</li>
						...
						<a href="Email.aspx#parentVerticalTab3" style="text-decoration: none"><li><i class="icon fa fa-envelope-o" aria-hidden="true"></i>向编辑发送电子邮件</li></a>
					</ul>
					</div>
                 ...
                 <div id="tab1" class="tab-grid">  
						...
						<ol>							
                            ...
                            <li>
                                ...
                                <ContentTemplate>
                                <asp:DropDownList ID="category_list" CssClass="selectpicker show-tick" data-live-search="true" runat="server" Height="16px" Width="183px" OnSelectedIndexChanged="category_list_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                                    </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            ...
                            <li>                               
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                                <ContentTemplate>                             
                                                <asp:DropDownList ID="article_list2" CssClass="selectpicker show-tick" runat="server" Height="40px" Width="600px" AutoPostBack="true" OnSelectedIndexChanged="article_list2_SelectedIndexChanged">
                                                </asp:DropDownList>
                                                </ContentTemplate>
                                                </asp:UpdatePanel>
                                </div>
                                ...
                                <div class="mobile-right ">
                                    ...
                                    <div class="mobile-rchge">
                                        <asp:UpdatePanel ID="UpdatePanel6" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                        <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" Height="129px" ReadOnly="True" Width="580px"></asp:TextBox>	
                                                        </ContentTemplate>
                                                        </asp:UpdatePanel>	
                                    </div>
                                    <div class="clearfix"></div>
                            ...
                            <li>
                                <asp:button runat="server" class="submit" Text="Download" onclick="Button2_Click"/>
                            </li>
				        </ol>
						</form>	
